...
/*
    ...
    Computes the gradient of the layer normalization with respect 
    to the weights gamma and beta.
*/
...
void main()
{
    ...
    for(int i = 0; i < samples; i++) {
        float x = (!bias ? texelFetch(sTD2DInputs[TEX_INPUT], ivec2(i, xy.y), 0).r : 1); // (transpose) point to right column
